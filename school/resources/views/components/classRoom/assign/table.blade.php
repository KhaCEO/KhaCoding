                    ...
                    <div class="d-md-flex ms-4 gap-2">
                        <div class="mb-2 input-group input-group-sm w-100">
                            <button class="btn btn-info btn-sm" data-bs-toggle="modal"
                                data-bs-target="#addSubjects">New Subjects</button>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        {{-- @foreach ($subjects as $data)
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-info btn-editSubjects" data-bs-toggle="modal"
                                        data-bs-target="#editSubjects" value="{{ $data->id }}">
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if(res.status == 200)
                        {
                           ...
                           {
                            $('#edit_sub_status').val(res.data.sub_status).prop("checked", true);
                           }
                           if(res.data.sub_delete == 1)
                           {
                            $('#edit_sub_delete').val(res.data.sub_delete).prop("checked", true);
                           }
                        }
                    }
                });
